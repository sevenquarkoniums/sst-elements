...
#include "DragonflyHybridAllocator.h"
...
DragonflyHybridAllocator::DragonflyHybridAllocator(const DragonflyMachine & mach)
  : DragonflyAllocator(mach)
{

}

std::string DragonflyHybridAllocator::getSetupInfo(bool comment) const
{
    std::string com;
    if (comment) {
        com = "# ";
