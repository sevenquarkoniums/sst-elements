...
public:
    ...
    MESIController(SST::Component* comp, Params& params) : CoherenceController(comp, params) {
        ...
        stat_stateEvent_GetS_I =    registerStatistic<uint64_t>("statEvent_GetS_I");
        stat_stateEvent_GetS_S =    registerStatistic<uint64_t>("statEvent_GetS_S");
        stat_stateEvent_GetS_E =    registerStatistic<uint64_t>("statEvent_GetS_E");
        stat_stateEvent_GetS_M =    registerStatistic<uint64_t>("statEvent_GetS_M");
        stat_stateEvent_GetX_I =    registerStatistic<uint64_t>("statEvent_GetX_I");
        stat_stateEvent_GetX_S =    registerStatistic<uint64_t>("statEvent_GetX_E");
        stat_stateEvent_GetX_E =    registerStatistic<uint64_t>("statEvent_GetX_S");
        stat_stateEvent_GetX_M =    registerStatistic<uint64_t>("statEvent_GetX_M");
        stat_stateEvent_GetX_SM =   registerStatistic<uint64_t>("statEvent_GetX_SM");
        stat_stateEvent_GetSEx_I =  registerStatistic<uint64_t>("statEvent_GetSEx_I");
        stat_stateEvent_GetSEx_S =  registerStatistic<uint64_t>("statEvent_GetSEx_S");
        stat_stateEvent_GetSEx_E =  registerStatistic<uint64_t>("statEvent_GetSEx_E");
        stat_stateEvent_GetSEx_M =  registerStatistic<uint64_t>("statEvent_GetSEx_M");
        stat_stateEvent_GetSEx_SM = registerStatistic<uint64_t>("statEvent_GetSEx_SM");
        stat_stateEvent_GetSResp_IS =       registerStatistic<uint64_t>("statEvent_GetSResp_IS");
        stat_stateEvent_GetXResp_IM =       registerStatistic<uint64_t>("statEvent_GetXResp_IM");
        stat_stateEvent_GetXResp_SM =       registerStatistic<uint64_t>("statEvent_GetXResp_SM");
        stat_stateEvent_GetXResp_SMInv =    registerStatistic<uint64_t>("statEvent_GetXResp_SMInv");
        stat_stateEvent_PutS_I =        registerStatistic<uint64_t>("statEvent_PutS_I");
        stat_stateEvent_PutS_S =        registerStatistic<uint64_t>("statEvent_PutS_S");
        stat_stateEvent_PutS_E =        registerStatistic<uint64_t>("statEvent_PutS_E");
        stat_stateEvent_PutS_M =        registerStatistic<uint64_t>("statEvent_PutS_M");
        stat_stateEvent_PutS_MInv =     registerStatistic<uint64_t>("statEvent_PutS_MInv");
        stat_stateEvent_PutS_EInv =     registerStatistic<uint64_t>("statEvent_PutS_EInv");
        stat_stateEvent_PutS_SInv =     registerStatistic<uint64_t>("statEvent_PutS_SInv");
        stat_stateEvent_PutS_SMInv =    registerStatistic<uint64_t>("statEvent_PutS_SMInv");
        stat_stateEvent_PutS_MI =       registerStatistic<uint64_t>("statEvent_PutS_MI");
        stat_stateEvent_PutS_EI =       registerStatistic<uint64_t>("statEvent_PutS_EI");
        stat_stateEvent_PutS_SI =       registerStatistic<uint64_t>("statEvent_PutS_SI");
        stat_stateEvent_PutS_IB =       registerStatistic<uint64_t>("statEvent_PutS_IB");
        stat_stateEvent_PutS_SB =       registerStatistic<uint64_t>("statEvent_PutS_SB");
        stat_stateEvent_PutS_SBInv =    registerStatistic<uint64_t>("statEvent_PutS_SBInv");
        stat_stateEvent_PutE_I =        registerStatistic<uint64_t>("statEvent_PutE_I");
        stat_stateEvent_PutE_E =        registerStatistic<uint64_t>("statEvent_PutE_E");
        stat_stateEvent_PutE_M =        registerStatistic<uint64_t>("statEvent_PutE_M");
        stat_stateEvent_PutE_MInv =     registerStatistic<uint64_t>("statEvent_PutE_MInv");
        stat_stateEvent_PutE_MInvX =    registerStatistic<uint64_t>("statEvent_PutE_MInvX");
        stat_stateEvent_PutE_EInv =     registerStatistic<uint64_t>("statEvent_PutE_EInv");
        stat_stateEvent_PutE_EInvX =    registerStatistic<uint64_t>("statEvent_PutE_EInvX");
        stat_stateEvent_PutE_MI =       registerStatistic<uint64_t>("statEvent_PutE_MI");
        stat_stateEvent_PutE_EI =       registerStatistic<uint64_t>("statEvent_PutE_EI");
        stat_stateEvent_PutM_I =        registerStatistic<uint64_t>("statEvent_PutM_I");
        stat_stateEvent_PutM_E =        registerStatistic<uint64_t>("statEvent_PutM_E");
        stat_stateEvent_PutM_M =        registerStatistic<uint64_t>("statEvent_PutM_M");
        stat_stateEvent_PutM_MInv =     registerStatistic<uint64_t>("statEvent_PutM_MInv");
        stat_stateEvent_PutM_MInvX =    registerStatistic<uint64_t>("statEvent_PutM_MInvX");
        stat_stateEvent_PutM_EInv =     registerStatistic<uint64_t>("statEvent_PutM_EInv");
        stat_stateEvent_PutM_EInvX =    registerStatistic<uint64_t>("statEvent_PutM_EInvX");
        stat_stateEvent_PutM_MI =       registerStatistic<uint64_t>("statEvent_PutM_MI");
        stat_stateEvent_PutM_EI =       registerStatistic<uint64_t>("statEvent_PutM_EI");
        stat_stateEvent_Inv_I =         registerStatistic<uint64_t>("statEvent_Inv_I");
        stat_stateEvent_Inv_S =         registerStatistic<uint64_t>("statEvent_Inv_S");
        stat_stateEvent_Inv_IS =        registerStatistic<uint64_t>("statEvent_Inv_IS");
        stat_stateEvent_Inv_IM =        registerStatistic<uint64_t>("statEvent_Inv_IM");
        stat_stateEvent_Inv_SM =        registerStatistic<uint64_t>("statEvent_Inv_SM");
        stat_stateEvent_Inv_SInv =      registerStatistic<uint64_t>("statEvent_Inv_SInv");
        stat_stateEvent_Inv_SMInv =     registerStatistic<uint64_t>("statEvent_Inv_SMInv");
        stat_stateEvent_Inv_SI =        registerStatistic<uint64_t>("statEvent_Inv_SI");
        stat_stateEvent_Inv_SB =        registerStatistic<uint64_t>("statEvent_Inv_SB");
        stat_stateEvent_Inv_IB =        registerStatistic<uint64_t>("statEvent_Inv_IB");
        stat_stateEvent_FetchInvX_I =       registerStatistic<uint64_t>("statEvent_FetchInvX_I");
        stat_stateEvent_FetchInvX_E =       registerStatistic<uint64_t>("statEvent_FetchInvX_E");
        stat_stateEvent_FetchInvX_M =       registerStatistic<uint64_t>("statEvent_FetchInvX_M");
        stat_stateEvent_FetchInvX_IS =      registerStatistic<uint64_t>("statEvent_FetchInvX_IS");
        stat_stateEvent_FetchInvX_IM =      registerStatistic<uint64_t>("statEvent_FetchInvX_IM");
        stat_stateEvent_FetchInvX_MInv =    registerStatistic<uint64_t>("statEvent_FetchInvX_MInv");
        stat_stateEvent_FetchInvX_MInvX =   registerStatistic<uint64_t>("statEvent_FetchInvX_MInvX");
        stat_stateEvent_FetchInvX_EInv =    registerStatistic<uint64_t>("statEvent_FetchInvX_EInv");
        stat_stateEvent_FetchInvX_EInvX =   registerStatistic<uint64_t>("statEvent_FetchInvX_EInvX");
        stat_stateEvent_FetchInvX_MI =      registerStatistic<uint64_t>("statEvent_FetchInvX_MI");
        stat_stateEvent_FetchInvX_EI =      registerStatistic<uint64_t>("statEvent_FetchInvX_EI");
        stat_stateEvent_FetchInvX_IB =      registerStatistic<uint64_t>("statEvent_FetchInvX_IB");
        stat_stateEvent_FetchInvX_SB =      registerStatistic<uint64_t>("statEvent_FetchInvX_SB");
        stat_stateEvent_Fetch_I =           registerStatistic<uint64_t>("statEvent_Fetch_I");
        stat_stateEvent_Fetch_S =           registerStatistic<uint64_t>("statEvent_Fetch_S");
        stat_stateEvent_Fetch_IS =          registerStatistic<uint64_t>("statEvent_Fetch_IS");
        stat_stateEvent_Fetch_IM =          registerStatistic<uint64_t>("statEvent_Fetch_IM");
        stat_stateEvent_Fetch_SM =          registerStatistic<uint64_t>("statEvent_Fetch_SM");
        stat_stateEvent_Fetch_SInv =        registerStatistic<uint64_t>("statEvent_Fetch_SInv");
        stat_stateEvent_Fetch_SI =          registerStatistic<uint64_t>("statEvent_Fetch_SI");
        stat_stateEvent_Fetch_IB =          registerStatistic<uint64_t>("statEvent_Fetch_IB");
        stat_stateEvent_Fetch_SB =          registerStatistic<uint64_t>("statEvent_Fetch_SB");
        stat_stateEvent_FetchInv_I =        registerStatistic<uint64_t>("statEvent_FetchInv_I");
        stat_stateEvent_FetchInv_S =        registerStatistic<uint64_t>("statEvent_FetchInv_S");
        stat_stateEvent_FetchInv_E =        registerStatistic<uint64_t>("statEvent_FetchInv_E");
        stat_stateEvent_FetchInv_M =        registerStatistic<uint64_t>("statEvent_FetchInv_M");
        stat_stateEvent_FetchInv_IS =       registerStatistic<uint64_t>("statEvent_FetchInv_IS");
        stat_stateEvent_FetchInv_IM =       registerStatistic<uint64_t>("statEvent_FetchInv_IM");
        stat_stateEvent_FetchInv_SM =       registerStatistic<uint64_t>("statEvent_FetchInv_SM");
        stat_stateEvent_FetchInv_MInv =     registerStatistic<uint64_t>("statEvent_FetchInv_MInv");
        stat_stateEvent_FetchInv_MInvX =    registerStatistic<uint64_t>("statEvent_FetchInv_MInvX");
        stat_stateEvent_FetchInv_EInv =     registerStatistic<uint64_t>("statEvent_FetchInv_EInv");
        stat_stateEvent_FetchInv_EInvX =    registerStatistic<uint64_t>("statEvent_FetchInv_EInvX");
        stat_stateEvent_FetchInv_SInv =     registerStatistic<uint64_t>("statEvent_FetchInv_SInv");
        stat_stateEvent_FetchInv_MI =       registerStatistic<uint64_t>("statEvent_FetchInv_MI");
        stat_stateEvent_FetchInv_EI =       registerStatistic<uint64_t>("statEvent_FetchInv_EI");
        stat_stateEvent_FetchInv_IB =       registerStatistic<uint64_t>("statEvent_FetchInv_IB");
        stat_stateEvent_FetchInv_SB =       registerStatistic<uint64_t>("statEvent_FetchInv_SB");
        stat_stateEvent_FetchResp_I =       registerStatistic<uint64_t>("statEvent_FetchResp_I");
        stat_stateEvent_FetchResp_MInv =    registerStatistic<uint64_t>("statEvent_FetchResp_MInv");
        stat_stateEvent_FetchResp_MInvX =   registerStatistic<uint64_t>("statEvent_FetchResp_MInvX");
        stat_stateEvent_FetchResp_EInv =    registerStatistic<uint64_t>("statEvent_FetchResp_EInv");
        stat_stateEvent_FetchResp_EInvX =   registerStatistic<uint64_t>("statEvent_FetchResp_EInvX");
        stat_stateEvent_FetchResp_MI =      registerStatistic<uint64_t>("statEvent_FetchResp_MI");
        stat_stateEvent_FetchResp_EI =      registerStatistic<uint64_t>("statEvent_FetchResp_EI");
        stat_stateEvent_FetchXResp_I =      registerStatistic<uint64_t>("statEvent_FetchXResp_I");
        stat_stateEvent_FetchXResp_MInv =   registerStatistic<uint64_t>("statEvent_FetchXResp_MInv");
        stat_stateEvent_FetchXResp_MInvX =  registerStatistic<uint64_t>("statEvent_FetchXResp_MInvX");
        stat_stateEvent_FetchXResp_EInv =   registerStatistic<uint64_t>("statEvent_FetchXResp_EInv");
        stat_stateEvent_FetchXResp_EInvX =  registerStatistic<uint64_t>("statEvent_FetchXResp_EInvX");
        stat_stateEvent_FetchXResp_MI =     registerStatistic<uint64_t>("statEvent_FetchXResp_MI");
        stat_stateEvent_FetchXResp_EI =     registerStatistic<uint64_t>("statEvent_FetchXResp_EI");
        stat_stateEvent_AckInv_I =          registerStatistic<uint64_t>("statEvent_AckInv_I");
        stat_stateEvent_AckInv_MInv =       registerStatistic<uint64_t>("statEvent_AckInv_MInv");
        stat_stateEvent_AckInv_MInvX =      registerStatistic<uint64_t>("statEvent_AckInv_MInvX");
        stat_stateEvent_AckInv_EInv =       registerStatistic<uint64_t>("statEvent_AckInv_EInv");
        stat_stateEvent_AckInv_EInvX =      registerStatistic<uint64_t>("statEvent_AckInv_EInvX");
        stat_stateEvent_AckInv_SInv =       registerStatistic<uint64_t>("statEvent_AckInv_SInv");
        stat_stateEvent_AckInv_SMInv =      registerStatistic<uint64_t>("statEvent_AckInv_SMInv");
        stat_stateEvent_AckInv_MI =         registerStatistic<uint64_t>("statEvent_AckInv_MI");
        stat_stateEvent_AckInv_EI =         registerStatistic<uint64_t>("statEvent_AckInv_EI");
        stat_stateEvent_AckInv_SI =         registerStatistic<uint64_t>("statEvent_AckInv_SI");
        stat_stateEvent_AckInv_SBInv =      registerStatistic<uint64_t>("statEvent_AckInv_SBInv");
        stat_stateEvent_AckPut_I =          registerStatistic<uint64_t>("statEvent_AckPut_I");
        stat_stateEvent_FlushLine_I =       registerStatistic<uint64_t>("statEvent_FlushLine_I");
        stat_stateEvent_FlushLine_S =       registerStatistic<uint64_t>("statEvent_FlushLine_S");
        stat_stateEvent_FlushLine_E =       registerStatistic<uint64_t>("statEvent_FlushLine_E");
        stat_stateEvent_FlushLine_M =       registerStatistic<uint64_t>("statEvent_FlushLine_M");
        stat_stateEvent_FlushLine_IS =      registerStatistic<uint64_t>("statEvent_FlushLine_IS");
        stat_stateEvent_FlushLine_IM =      registerStatistic<uint64_t>("statEvent_FlushLine_IM");
        stat_stateEvent_FlushLine_SM =      registerStatistic<uint64_t>("statEvent_FlushLine_SM");
        stat_stateEvent_FlushLine_MInv =    registerStatistic<uint64_t>("statEvent_FlushLine_MInv");
        stat_stateEvent_FlushLine_MInvX =   registerStatistic<uint64_t>("statEvent_FlushLine_MInvX");
        stat_stateEvent_FlushLine_EInv =    registerStatistic<uint64_t>("statEvent_FlushLine_EInv");
        stat_stateEvent_FlushLine_EInvX =   registerStatistic<uint64_t>("statEvent_FlushLine_EInvX");
        stat_stateEvent_FlushLine_SInv =    registerStatistic<uint64_t>("statEvent_FlushLine_SInv");
        stat_stateEvent_FlushLine_SMInv =   registerStatistic<uint64_t>("statEvent_FlushLine_SMInv");
        stat_stateEvent_FlushLine_MI =      registerStatistic<uint64_t>("statEvent_FlushLine_MI");
        stat_stateEvent_FlushLine_EI =      registerStatistic<uint64_t>("statEvent_FlushLine_EI");
        stat_stateEvent_FlushLine_SI =      registerStatistic<uint64_t>("statEvent_FlushLine_SI");
        stat_stateEvent_FlushLine_IB =      registerStatistic<uint64_t>("statEvent_FlushLine_IB");
        stat_stateEvent_FlushLine_SB =      registerStatistic<uint64_t>("statEvent_FlushLine_SB");
        stat_stateEvent_FlushLineInv_I =        registerStatistic<uint64_t>("statEvent_FlushLineInv_I");
        stat_stateEvent_FlushLineInv_S =        registerStatistic<uint64_t>("statEvent_FlushLineInv_S");
        stat_stateEvent_FlushLineInv_E =        registerStatistic<uint64_t>("statEvent_FlushLineInv_E");
        stat_stateEvent_FlushLineInv_M =        registerStatistic<uint64_t>("statEvent_FlushLineInv_M");
        stat_stateEvent_FlushLineInv_IS =       registerStatistic<uint64_t>("statEvent_FlushLineInv_IS");
        stat_stateEvent_FlushLineInv_IM =       registerStatistic<uint64_t>("statEvent_FlushLineInv_IM");
        stat_stateEvent_FlushLineInv_SM =       registerStatistic<uint64_t>("statEvent_FlushLineInv_SM");
        stat_stateEvent_FlushLineInv_MInv =     registerStatistic<uint64_t>("statEvent_FlushLineInv_MInv");
        stat_stateEvent_FlushLineInv_MInvX =    registerStatistic<uint64_t>("statEvent_FlushLineInv_MInvX");
        stat_stateEvent_FlushLineInv_EInv =     registerStatistic<uint64_t>("statEvent_FlushLineInv_EInv");
        stat_stateEvent_FlushLineInv_EInvX =    registerStatistic<uint64_t>("statEvent_FlushLineInv_EInvX");
        stat_stateEvent_FlushLineInv_SInv =     registerStatistic<uint64_t>("statEvent_FlushLineInv_SInv");
        stat_stateEvent_FlushLineInv_SMInv =    registerStatistic<uint64_t>("statEvent_FlushLineInv_SMInv");
        stat_stateEvent_FlushLineInv_MI =       registerStatistic<uint64_t>("statEvent_FlushLineInv_MI");
        stat_stateEvent_FlushLineInv_EI =       registerStatistic<uint64_t>("statEvent_FlushLineInv_EI");
        stat_stateEvent_FlushLineInv_SI =       registerStatistic<uint64_t>("statEvent_FlushLineInv_SI");
        stat_stateEvent_FlushLineInv_IB =       registerStatistic<uint64_t>("statEvent_FlushLineInv_IB");
        stat_stateEvent_FlushLineInv_SB =       registerStatistic<uint64_t>("statEvent_FlushLineInv_SB");
        stat_stateEvent_FlushLineResp_I =       registerStatistic<uint64_t>("statEvent_FlushLineResp_I");
        stat_stateEvent_FlushLineResp_IB =      registerStatistic<uint64_t>("statEvent_FlushLineResp_IB");
        stat_stateEvent_FlushLineResp_SB =      registerStatistic<uint64_t>("statEvent_FlushLineResp_SB");
    }
...
/* Statistics */
    ...
    Statistic<uint64_t>* stat_stateEvent_GetX_SM;
    ...
    Statistic<uint64_t>* stat_stateEvent_GetSEx_SM;
