...
public:
    ...
    MESIInternalDirectory(Component * comp, Params& params) : CoherenceController(comp, params) {
        ...
        stat_stateEvent_GetS_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetS_S = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetS_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetS_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetX_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetX_S = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetX_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetX_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetX_SM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetSEx_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetSEx_S = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetSEx_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetSEx_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_GetSEx_SM = registerStatistic<uint64_t>("stateEvent_GetSEx_SM");
        ...
        stat_stateEvent_GetXResp_SM_Inv = registerStatistic<uint64_t>("stateEvent_GetXResp_SMInv");
        stat_stateEvent_PutS_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_S = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_SInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_SMInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_SI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_IB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_SB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_SBInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_SD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_ED = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_MD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutS_SMD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_MInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutE_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_MInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_PutM_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_S = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_SM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_MInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_SInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_SMInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_SI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_SB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_IB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_SD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_ED = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Inv_MD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInvX_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInvX_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInvX_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInvX_IS = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInvX_IM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInvX_IB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInvX_SB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Fetch_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Fetch_S = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Fetch_IS = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Fetch_IM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Fetch_SM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Fetch_SD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Fetch_SInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_Fetch_SI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_IS = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_IM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_MInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_IB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_SD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_ED = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchInv_MD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_MInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_SD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_ED = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_MD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_SMD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_SInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_SMInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchResp_SI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_MInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_SD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_ED = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_MD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_SMD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_SInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_SMInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FetchXResp_SI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_SInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_SMInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_SI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckInv_SBInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_AckPut_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_S = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_IS = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_IM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_SM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_MInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_SInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_SMInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_SD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_ED = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_MD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_SMD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_SI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_IB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLine_SB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_S = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_E = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_M = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_IS = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_IM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_SM = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_MInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_MInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_EInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_EInvX = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_SInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_SMInv = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_SD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_ED = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_MD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_SMD = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_MI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_EI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineInv_SI = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineResp_I = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineResp_IB = registerStatistic<uint64_t>("stateEvent_");
        stat_stateEvent_FlushLineResp_SB = registerStatistic<uint64_t>("stateEvent_");
    }
...
/* Statistics */
    ...
    Statistic<uint64_t>* stat_stateEvent_GetXResp_SM_Inv;
